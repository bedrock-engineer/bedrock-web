...
- [QGIS](https://qgis.org/download/) installed on your system
...
Use [EPSG.io](https://epsg.io/) to find the correct codes for your project location.
...
**Coordinate system issues**: Verify the EPSG codes match your project's spatial reference systems using [EPSG.io](https://epsg.io/).
