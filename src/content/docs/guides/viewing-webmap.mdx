...
<LinkButton href="/webmap/index.html">View it here</LinkButton>

You can also explore the data preparation workflow interactively in a [marimo notebook](link-here), a [reactive Python notebook](https://marimo.io/) that automatically updates when you modify data or code.

### Prerequisites

Before starting, ensure you have:

- **Python 3.10+** with ability to install packages (we recommend [`uv`](https://docs.astral.sh/uv/)).
