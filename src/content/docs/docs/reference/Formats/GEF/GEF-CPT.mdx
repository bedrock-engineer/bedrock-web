...
GEF suffers from fragmentation between different ground investigation companies and software, so files aren't reliably interoperable without adaptation.

<small>1. 'Human-readable' is rather generous. I'd call it human-openable-a-in-a-text-editor at most</small>

<svg  viewBox="-8,-24,728,784" style="max-width: 100%; height: auto; font: 11.428571428571429px sans-serif; overflow: visible;"
    ...
    <g fill="currentColor">
        ...
        <g transform="translate(0,384)">
            <circle cx="32" r="2" />
            <text dy="0.32em" x="38">
                <tspan font-weight="600" font-family="monospace" text-decoration="none">#COLUMNSEPARATOR</tspan>
        ...
        <g transform="translate(0,400)">
            <circle cx="32" r="2" />
            <text dy="0.32em" x="38">
                <tspan font-weight="600" font-family="monospace" text-decoration="none">#RECORDSEPARATOR</tspan>
        ...
        <g transform="translate(0,432)">
            <circle cx="32" r="2" />
            <text dy="0.32em" x="38">
                <tspan font-weight="600" font-family="monospace" text-decoration="none">#REPORTDATAFORMAT</tspan>
        ...
        <g transform="translate(0,464)">
            <circle cx="32" r="2" />
            <text dy="0.32em" x="38">
                <tspan font-weight="600" font-family="monospace" text-decoration="none">#COLUMNMINMAX</tspan>
        ...
        <g transform="translate(0,512)">
            <circle cx="32" r="2" />
            <text dy="0.32em" x="38">
                <tspan font-weight="600" font-family="monospace" text-decoration="none">#MEASUREMENTVAR</tspan>
        ...
        <g transform="translate(0,528)">
            <circle cx="32" r="2" />
            <text dy="0.32em" x="38">
                <tspan font-weight="600" font-family="monospace" text-decoration="none">#MEASUREMENTTEXT</tspan>
...
- [Voorbij: Ontstaan en lancering module 1 drukpalen](https://www.voorbijfunderingstechniek.nl/blogs/blog-2-ontstaan-en-lancering-module-1-drukpalen)