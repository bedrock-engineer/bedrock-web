...
If you've ever worked with Ground Investigation (GI) data, you've probably encountered it in Excel spreadsheets, PDF reports, or specialized file formats like [AGS](/reference/formats/ags/ags4/) or [GEF](http://bedrock.engineer/reference/formats/gef/gef/).
