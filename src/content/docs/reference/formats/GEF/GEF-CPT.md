...
- Since 2018, data submission in IMBRO/XML format is required.
- By July 1, 2025, governmental data holders must convert historical GEF-CPT data to IMBRO/XML.
...
* [Toelichting DOV-GEF formaat](https://www.milieuinfo.be/confluence/display/DDOV/Toelichting+DOV-GEF+formaat)
