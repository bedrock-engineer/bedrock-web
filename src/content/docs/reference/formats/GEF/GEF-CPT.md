...
The GEF-CPT format is a legacy text-based data exchange format for Cone Penetration Test (CPT) data, primarily used in the Netherlands and Belgium.
...
{% linkcard
   title="View GEF CPT files in your browser"
